...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/30 py-16 sm:py-24 lg:py-36">
      ...
      <div className="pointer-events-none absolute -top-40 -right-40 h-[300px] w-[300px] rounded-full bg-primary/10 blur-3xl sm:h-[500px] sm:w-[500px]" />
      <div className="pointer-events-none absolute -bottom-40 -left-40 h-[250px] w-[250px] rounded-full bg-accent/20 blur-3xl sm:h-[400px] sm:w-[400px]" />
